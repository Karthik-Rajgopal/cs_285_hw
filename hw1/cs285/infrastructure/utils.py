...
def sample_trajectory(env, policy, max_path_length, render=False):
    ...
    while True:
        ...
        ac = policy.forward(ob).detach().cpu().numpy() # HINT: this is a numpy array
        ...
        steps += 1
        rollout_done = True if steps >= max_path_length else False
...
def convert_listofrollouts(paths, concat_rew=True):
    ...
    # print(observations.shape)  # (2000, 27)
    # print(actions.shape)       # (2000, 8)
    # exit() 
    if concat_rew:
